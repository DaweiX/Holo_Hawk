...
class Key:
    ...
    def distribute_publickey(self, host, port, mark， num_of_node):
        ...
        server = socketserver.ThreadingTCPServer((host[1],port),myTCPhandler,bind_and_activate = False)
        ...
        message = ('received'+ "-" + mark).encode("utf8")
        self.public_all[3]= client.client(host[3], port, message)
